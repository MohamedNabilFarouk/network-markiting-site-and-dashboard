           ...
           <!-- Product main img -->
            ...
            <div class="col-md-5">
                <div class="product-details trans">
                    ...
                    <div>
                        <h3 class="product-price">ج.م{{$product->price}}</h3>
                    ...
                    <div class="add-to-cart">
                        ...
                        <a href="{{route('get.checkout',$product->id)}}"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> اشتري الان</button></a>
                    </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-12">
                    <div class="section-title text-center">
                        <h3 class="title">منتجات ذات صلة</h3>
                    </div>
                </div>
