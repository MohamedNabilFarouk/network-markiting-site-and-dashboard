...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center me-3">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">@lang('site.Packages')
            <!--begin::Separator-->
...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">@lang('site.All Packages')</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{route('package.create')}}" class="btn btn-sm btn-light-primary">
            ...
            <!--end::Svg Icon-->@lang('site.add') @lang('site.package') +</a>
        </div>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-125px">@lang('site.Details') @lang('site.in English')</th>
                        <th class="min-w-125px">@lang('site.Details') @lang('site.in Arabic')</th>
                    ...
                    <tr class="text-center border-3 m-auto">
                         <td class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('package.edit', $c->id) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->name_en}}</a>
                                    <span class="text-muted fw-bold text-muted d-block fs-7">{{$c->name_ar}}</span>
                                </div>
                            </div>
                        </td>

                         <td class="px-3">{!!$c->des_en!!}</td>
                         <td class="px-3">{!!$c->des_ar!!}</td>
                         <td class="px-3">
                        @if($c->status == 1)
                        ...
                        @endif
                         ...
                         <td class="px-3">
                            ...
                            <a href="{{ route('package.edit', $c->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <form action="{{ route('package.destroy', $c->id) }}" method="post" id='delform' style="display: inline-block">
                                @csrf
                                @method('delete')
