 ...
 <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
     ...
     <div class="aside-logo flex-column-auto" id="kt_aside_logo" style="height: 120px;">
         <!--begin::Logo-->
         <a href="#" class="m-auto">
             <img alt="Logo" src="{{ $site_settings->logo }}" class=" logo" style="height: 100px;width: 100%;" />
     ...
     <div class="aside-menu flex-column-fluid">
         ...
         <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 <!-- your codes -->
                 <div class="menu-item">
                     <a class="menu-link" href="{{ route('yourcodes') }}">
                         <span class="menu-icon">
                             <!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
                             <span class="svg-icon svg-icon-2">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                         ...
                         <div class="menu-sub menu-sub-accordion menu-active-bg">
                             <div class="menu-item">
                                 <a class="menu-link" href="{{ route('order.index') }}">
                                     ...
                                     <span class="menu-title">كل الطلبات</span>
                                 </a>
                             </div>
                             {{--
                             <div class="menu-item">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('settings.social.show') }}">
                                    ...
                                    <span class="menu-title">التواصل الاجتماعي</span>
                                </a>
                            </div>
