        ...
        <div id="kt_content_container" class="container">
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="" class="text-warning fw-bold fs-6">المنتجات :</a> <br />
                                        {{COUNT($products)}}
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-bold fs-6">المستخدمين : </a> <br />
                                        {{COUNT($users)}}
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                        ...
                                        <a href="" class="text-danger fw-bold fs-6 mt-2">الطلبات : </a> <br />
                                        {{count($orders)}}
                                    </div>
                                    <!--end::Col-->
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="" class="text-warning fw-bold fs-6">الرصيد :</a> <br />
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-bold fs-6">الكود : </a> <br />
                                        @foreach($codes as $c)
                                        <div class="d-flex align-items-center @if($c->child_id != NULL ) bg-light-danger @elseif($c->child_id == NULL && $c->updated_at < Carbon\Carbon::now()->subDays(10)) bg-dark @else bg-light-warning @endif rounded p-5 mb-7">
                                            <!--begin::Icon-->
                                            ...
                                            <div class="flex-grow-1 me-2">
                                                ...
                                                @if($c->child_id != NULL )
                                                <span class="text-muted fw-bold d-block">استخدم بواسطة {{$c->childuser->email ??''}}</span>
                                                @endif
                                                @if(Auth::user()->hasRole('admin'))
                                                <span class="text-muted fw-bold d-block">صاحب الكود : <br><a href="{{ route('user.edit', $c->parentuser->id) }}"> {{$c->parentuser->email ??''}}</a></span>
                                                @endif
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Lable-->
            ...
            <div class="row g-5 gx-xxl-8">
                ...
                <div class="col-xxl-12">
                        ...
                        <div class='col-md-12'>
                            <h3 class="card-title fw-bolder text-Black">المستخدمين   </h3>
                            <div class="card-body py-3">
                                <!--begin::Table container-->
                                    ...
                                    <table class="table table-hover align-middle gs-0 gy-4">
                                        ...
                                        <thead>
                                            <tr class="text-center border-3 fw-bolder text-muted bg-light">
                                                ...
                                                <th class="min-w-125px">@lang('site.generation')</th>
                                                 <th class="min-w-125px">{{__('site.Code')}}</th>
